...
public class HandlerResponse {
    ...
    public static void responseSuccessCreatedWithData(HttpServletResponse response, DataResponse<?> data){
        data.setStatus(STATUS_SUCCESS);
        data.setCode(HttpServletResponse.SC_CREATED);
        responseWriter(response, data, data.getCode());
    }

    public static void responseSuccessCreatedWithData(HttpServletResponse response, String message){
        if (message.isEmpty()){
            message = "CREATED";
        }
    ...
    public static void responseNotFoundRequest(HttpServletResponse response, String errorCode, String error){
        if (error.isEmpty()){
            error = "NOT FOUND";
        }
